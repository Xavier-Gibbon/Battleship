...
static class EndingGameController
{
	...
	public static void DrawEndOfGame()
	{
		...
		} else if (GameController.GameMode == Mode.Timed && DiscoveryController.TimerAt >= 180000) {
			SwinGame.DrawTextLines("OUT OF TIME!", Color.White, Color.Transparent, GameResources.GameFont("ArialLarge"), FontAlignment.AlignCenter, 0, 250, SwinGame.ScreenWidth(), SwinGame.ScreenHeight());
		} else {
